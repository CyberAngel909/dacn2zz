...
class AboutDialog(object):
    ...
    def ShowDialog(self):
        ...
        info.SetCopyright("(c) 2021-2022 {}. All rights reserved.".format(self._author))
        info.SetDescription(
            wordwrap(
                margin=10,
                text="""
This version of N&D Studio is made possible thanks to the following open-source projects:
...
Please consider giving your feedback through the program menu (Help > Feedback Survey) so that I can work to improve N&D Studio. :)
                """.format(
                    self._pythonVersion,
                    self._pillowVersion,
